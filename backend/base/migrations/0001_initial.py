# Generated by Django 5.2.1 on 2025-06-20 22:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('verb', models.CharField(choices=[('follow', 'Follow'), ('follow_request', 'Follow request'), ('like', 'Like'), ('comment', 'Comment'), ('mention_post', 'Mention in post'), ('mention_comment', 'Mention in comment'), ('fr_accepted', 'Follow request accepted')], max_length=20)),
