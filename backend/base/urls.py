...
urlpatterns = [
    ...
    path('follow-requests/respond/all/', RespondAllFollowRequests, name='follow_requests_respond_all'),
    path('follow-requests/respond/<int:id>/', RespondFollowRequest, name='follow_request_respond'),
    path('notifications/', NotificationListView.as_view(), name='notifications'),
    path('notifications/last/', GetLastNotifications, name='get_last_notifications'),
